...
$config = [
    ...
    'controllers' => [
        'factories' => [
            ...
            'VuFind\Controller\UnionController' => 'VuFind\Controller\AbstractBaseFactory',
    ...
    'service_manager' => [
        ...
        'factories' => [
            ...
            'VuFind\Content\Series\PluginManager' => 'VuFind\ServiceManager\AbstractPluginManagerFactory',
        ...
        'aliases' => [
            ...
            'VuFind\ContentSeriesPluginManager' => 'VuFind\Content\Series\PluginManager',
    ...
    'vufind' => [
        ...
        'plugin_managers' => [
            ...
            'content_series' => [ /* see VuFind\Content\Series\PluginManager for defaults */ ],
        ...
        'recorddriver_tabs' => [
            ...
            'VuFind\RecordDriver\SolrMarc' => [
                'tabs' => [
                    ...
                    'Preview' => 'preview', 'Summaries' => 'Summaries',
                    'HierarchyTree' => 'HierarchyTree', 'Map' => 'Map',
                    'Series' => 'Series', 'Similar' => 'SimilarItemsCarousel',
                    'Details' => 'StaffViewMARC',
                ],
                'defaultTab' => null,
            ],
...
$staticRoutes = [
    ...
    'MyResearch/Delete', 'MyResearch/DeleteAccount', 'MyResearch/DeleteList', 'MyResearch/DismissAnnouncement',
    'MyResearch/Edit', 'MyResearch/Email', 'MyResearch/Facets', 'MyResearch/Favorites',
    'MyResearch/Fines', 'MyResearch/GetCard', 'MyResearch/HistoricLoans', 'MyResearch/Holds',
    'MyResearch/Home', 'MyResearch/ILLRequests', 'MyResearch/Logout', 'MyResearch/LogoutWarning', 'MyResearch/MyList',
    'MyResearch/NewPassword', 'MyResearch/Notifications', 'MyResearch/PINReset', 'MyResearch/Profile', 'MyResearch/ReadingHistory',
