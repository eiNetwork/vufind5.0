    ...
    HttpServiceAwareInterface, LoggerAwareInterface
{
    ...
    public function patronLogin($username, $password)
    {
        ...
        $result = $this->makeRequest(
            ['v' . $this->apiVersion, 'patrons', $patronId],
            ['fields' => 'names,emails'],
            'GET',
            ['cat_username' => $username, 'cat_password' => $password]
        );
    ...
    {
        $result = $this->makeRequest(
            ['v' . $this->apiVersion, 'patrons', $patron['id']],
            [
    ...
    public function renewMyItems($renewDetails)
    {
        ...
        foreach ($renewDetails['details'] as $details) {
            ...
            $result = $this->makeRequest(
                ['v' . $this->apiVersion, 'patrons', 'checkouts', $checkoutId, 'renewal'], [], 'POST',
                $patron
            );
    ...
    public function getMyTransactionHistory($patron, $params)
    {
        ...
        $sortOrder = isset($params['sort']) && 'checkout asc' === $params['sort']
            ? 'asc' : 'desc';
        $result = $this->makeRequest(
            ['v' . $this->apiVersion, 'patrons', $patron['id'], 'checkouts', 'history'],
            [
                'limit' => $pageSize,
                'offset' => $offset,
                'sortField' => 'outDate',
    ...
    public function placeHold($holdDetails)
    {
        ...
        $result = $this->makeRequest(
            ['v' . $this->apiVersion, 'patrons', $patron['id'], 'holds', 'requests'],
            json_encode($request),
            'POST',
            $patron
        );
