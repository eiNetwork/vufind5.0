    ...
    public function __invoke($showAnnouncements = true)
    {
        ...
        foreach ($namespaces as $ns) {
            ...
            foreach (array_unique($messages, SORT_REGULAR) as $msg) {
                ...
                $html .= '<div class="' . ((strpos($msg['msg'], '<nodesktop></nodesktop>') !== false) ? "EIN-hide " : "") . ((strpos($msg['msg'], 'fa-exclamation-triangle') == false) ? ((strpos($msg['msg'], 'fa-exclamation') == false) ? $this->getClassForNamespace($ns) : 'alert alert-blue') : 'alert alert-danger') . ' alert-dismissible">';
