<?php
/**
 * Factory for EIN GetListContents AJAX handler.
 *
 * PHP version 7
 *
...
/**
 * Factory for EINGetListContents AJAX handler.
 *
 * @category VuFind
 * @package  AJAX
 * @author   Demian Katz <demian.katz@villanova.edu>
 ...
 * @link     https://vufind.org/wiki/development Wiki
 */
class EINGetListContentsFactory implements \Zend\ServiceManager\Factory\FactoryInterface
{
    /**
     * Create an object
     *
    ...
    public function __invoke(ContainerInterface $container, $requestedName,
        ...
        return new $requestedName(
            ...
            $container->get('VuFind\Db\Table\PluginManager')->get('UserList'),
