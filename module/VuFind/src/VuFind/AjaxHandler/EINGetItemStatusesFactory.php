<?php
/**
 * Factory for EIN GetItemStatus AJAX handler.
 *
 * PHP version 7
 *
...
/**
 * Factory for EINGetItemStatus AJAX handler.
 *
 * @category VuFind
 * @package  AJAX
 * @author   Demian Katz <demian.katz@villanova.edu>
 ...
 * @link     https://vufind.org/wiki/development Wiki
 */
class EINGetItemStatusesFactory implements \Zend\ServiceManager\Factory\FactoryInterface
{
    /**
     * Create an object
     *
